<x-app-layout>
    ...
    <x-slot name="pageTitle">
        Glop Analytics | Todos tus datos en un único sitio
    </x-slot>
    <x-slot name="pageDescription">
        Controla la analítica de tus establecimientos desde un solo sitio. Cuadro de mandos - usuarios - informes personalizados - Envíos directo a la asesoría
    </x-slot>
                        ...
                        <g id="Background">
                            ...
                            <g id="Image">
                                ...
                                <path id="Fill 47" fill-rule="evenodd" clip-rule="evenodd"
                                    d="M934.411 180.182C934.395 180.211 934.484 180.069 934.411 180.182V180.182Z"
                                    fill="#C4CFD6" />
                            ...
                            <g id="Image_2">
                                ...
                                <path id="Fill 47_2" fill-rule="evenodd" clip-rule="evenodd"
                                    d="M100.544 559.722C100.56 559.751 100.471 559.609 100.544 559.722V559.722Z"
                                    fill="#C4CFD6" />
                            ...
                            <g id="Lower Body/Standing">
                                <g id="Lower Body/Standing/Baggy Pants">
                                    ...
                                    <path id="Pant" fill-rule="evenodd" clip-rule="evenodd"
                                        d="M734.65 634.689L654.993 626.632L719.184 372.334H785.375L734.65 634.689Z"
                                        fill="#C4C4C4" />
                                ...
                                <g id="Upper Body/Pointing Forward">
                                    ...
                                    <g id="manos">
                                        <path id="Mask" fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#BA470B" />
                                        <mask id="mask0_12_2314" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                            x="454" y="363" width="74" height="45">
                                    ...
                                    <g id="Group 27">
                                        <path id="Mask_3" fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#FE7E10" />
                                        <mask id="mask1_12_2314" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                            x="376" y="333" width="203" height="175">
    ...
    <!-- Testimonios generados dinámicamente a través de la plantilla "tarjetas" por JavaScript y obteniendo datos desde la API https://randomuser.me/  -->
